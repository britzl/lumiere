...
void main()
{
	...
	//vec2 input_offset = vec2(var_texcoord0.x + distortion, var_texcoord0.y);
	//distortion *= distort_color.a;
	...
	//gl_FragColor = texture2D(distort_tex, var_texcoord0.xy);
	gl_FragColor = input_color + distort_color;
}
